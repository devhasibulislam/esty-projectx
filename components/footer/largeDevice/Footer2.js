/**
 * Title: Write a program using JavaScript on Footer2
  ...
  return (
    <section className="w-full h-full">
      <svg
        ...
        strokeWidth={1.5}
        stroke="currentColor"
        className="text-[#4f66c2] bg-[#feecd4] rotate-180 w-full"
        style={{ fill: "#4f66c2" }}
      >
      ...
      <div className="bg-[#4f66c2] pb-2">
        <div className="max-w-7xl mx-auto bg-[#4f66c2]">
          <p className="flex flex-row gap-x-2 items-center justify-center cursor-pointer mt-0 w-fit mx-auto bg-[#4f66c2]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 96 96"
              aria-hidden="true"
            ...
            <span className="text-white border-b-2 border-dashed">
