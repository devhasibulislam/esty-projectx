/**
 * Title: Write a program using JavaScript on Footer3
  ...
  const items = [
    {
      ...
      subItems: [
        ...
        {
          name: "Etsy United Kingdom",
          path: "/etsy-united-kingdom",
        },
        {
          name: "Etsy Germany",
          path: "/etsy-germany",
    ...
    },
    {
      ...
      subItems: [
        ...
        {
          name: "Affiliates & Creators",
          path: "/affiliates-and-creators",
        },
      ],
    },
    {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 gap-4">
          ...
          <div className="flex flex-col gap-y-4 mx-auto">
            <button className="flex flex-row items-center gap-x-1 text-white border border-white text-sm px-4 py-1 rounded-full hover:px-6 transition-all ease-linear delay-100">
              <svg
            ...
            <div className="flex flex-row items-center gap-x-2.5 mx-auto">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
                fill="currentColor"
                className="w-6 h-6 text-white hover:scale-105 transition-all ease-linear delay-100"
                viewBox="0 0 16 16"
              >
